...
function spesenSort(mode) {
  ...
  ["gesamt","name","tage"].forEach(function(m){
    ...
    if(btn){ btn.style.background = mode === m ? "#6d28d9" : "#fff"; btn.style.color = mode === m ? "#fff" : "#6d28d9"; }
  });
  spesenFilteredCache = null;
  spesenRefresh();
}
...
function spesenUpdateSidebarHighlight() {
  ...
  for(var i=0; i<items.length; i++){
    ...
    el.style.background = act ? "#6d28d9" : "#fff";
...
function spesenShowDetail(name) {
  ...
  html += "<button onclick='spesenPdfOne(" + JSON.stringify(d.name) + ")' "
        + "style='padding:7px 14px;background:linear-gradient(180deg,#8b5cf6 0%,#6d28d9 100%);color:#fff;border:none;border-radius:6px;"
        + "font-weight:800;font-size:11px;cursor:pointer;font-family:inherit;white-space:nowrap;box-shadow:0 1px 3px rgba(109,40,217,.32);'>"
        + "&#128196; PDF drucken</button>";
  ...
  html += "<thead><tr style='background:#ede9fe;color:#6d28d9;text-align:left;'>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Datum</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Start</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Ende</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Dauer</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Fahrzeug</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;position:sticky;top:0;background:#ede9fe;z-index:1;'>Strecke</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;text-align:right;position:sticky;top:0;background:#ede9fe;z-index:1;'>Steuerfrei</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;text-align:right;position:sticky;top:0;background:#ede9fe;z-index:1;'>Steuerpflichtig</th>" +
          "<th style='padding:9px 10px;border-bottom:1px solid #cbd5e1;text-align:right;position:sticky;top:0;background:#ede9fe;z-index:1;'>Gesamt</th>" +
          "</tr></thead><tbody>";
  if(!s.rows.length) {
    ...
    s.rows.forEach(function(r, idx){
      ...
      if(showMonthSeparator && r.month && r.month !== lastMonth){
        html += "<tr style='background:#f1f5f9;'><td colspan='9' style='padding:6px 12px;font-size:11px;font-weight:900;color:#6d28d9;text-transform:uppercase;letter-spacing:.4px;border-bottom:1px solid #cbd5e1;'>" + spEsc(spMonthLabel(r.month)) + "</td></tr>";
        lastMonth = r.month;
      }
      ...
      html += "<td style='padding:8px 10px;border-bottom:1px solid #e2e8f0;text-align:right;font-weight:900;color:#6d28d9;'>" + spMoney(spTaxFree(r) + spTaxable(r)) + "</td>";
      html += "</tr>";
    });
  }
...
function spesenPdfOne(name) {
  ...
  var css = "@page{size:A4 portrait;margin:11mm}"
    ...
    + "tbody tr.sep td{background:#ede9fe;color:#6d28d9;font-weight:900;font-size:7.5pt;text-transform:uppercase;letter-spacing:.4px;padding:1.4mm 2.5mm;border-bottom:1px solid #cbd5e1}"
  ...
  body += "<div class='kpi'>"
    + "<div><div class='num' style='color:#6d28d9;'>" + spMoney(s.total) + "</div><div class='lbl'>Gesamt</div></div>"
  ...
  s.rows.forEach(function(r){
    ...
    body += "<tr" + rowCls + ">"
      ...
      + "<td style='text-align:right;font-weight:800;color:#6d28d9;font-variant-numeric:tabular-nums;white-space:nowrap;'>"
...
function spesenShowLateStarts() {
  ...
  var cards = [
    ...
    ["Σ Gesamt", spMoney(allTotal), "#6d28d9"]
  ];
  ...
  monthKeys.forEach(function(k){
    ...
    html += "<div style='font-size:11px;color:#64748b;font-weight:700;'>" + mo.entries.length + " Einträge · " + monthDriverCount + " Fahrer · Σ <b style='color:#6d28d9;'>" + spMoney(mo.total) + "</b></div>";
    html += "</div>";
    ...
    mo.entries.forEach(function(e, idx){
      ...
      html += "<tr style='background:" + bg + ";cursor:pointer;' onclick='spesenShowDetail(" + JSON.stringify(e.driver.name) + ")' title='Zur Detailansicht von " + spEsc(e.driver.name) + "'>"
           ...
           + "</td>"
           + "<td style='padding:8px 10px;border-bottom:1px solid #e2e8f0;font-weight:800;color:#6d28d9;font-variant-numeric:tabular-nums;white-space:nowrap;'>" + spEsc(r.start_time || "—") + "</td>"
           ...
           + "<td style='padding:8px 10px;border-bottom:1px solid #e2e8f0;text-align:right;font-weight:900;color:#6d28d9;font-variant-numeric:tabular-nums;white-space:nowrap;'>" + spMoney(spTaxFree(r) + spTaxable(r)) + "</td>"
           + "</tr>";
    });

    // Summen-Zeile pro Monat
    html += "<tr style='background:#ede9fe;'>"
         + "<td colspan='5' style='padding:9px 10px;text-align:right;font-weight:900;color:#5b21b6;text-transform:uppercase;font-size:11px;letter-spacing:.4px;'>Summe " + spEsc(mo.label || k) + "</td>"
         ...
         + "<td style='padding:9px 10px;text-align:right;font-weight:900;color:#6d28d9;font-variant-numeric:tabular-nums;'>" + spMoney(mo.total) + "</td>"
         + "</tr>";
    html += "</tbody></table></div>";
  });
...
function verstossRender() {
  ...
  drivers.forEach(function(d, i) {
    ...
    var rowBg = isOpen ? "#eef2ff" : (isRecent ? "#fff7f7" : (i % 2 === 0 ? "#ffffff" : "#f8fafc"));
    ...
    if (isOpen) {
      ...
      html += "<div style='display:flex;align-items:center;gap:10px;padding:12px 16px;border-bottom:1px solid #cbd5e1;background:linear-gradient(180deg,#eef2ff 0%,#f8fafc 100%);flex-wrap:wrap;'>";
      ...
      detailList.forEach(function(v, j) {
        ...
        if (monthLabel !== currentMonth) {
          ...
          html += "<tr style='background:#e0e7ff;'><td colspan='8' style='padding:8px 12px;color:#1e3a5f;font-size:10px;font-weight:950;text-transform:uppercase;letter-spacing:.55px;border-top:1px solid #bfdbfe;border-bottom:1px solid #bfdbfe;'>" + verstossEsc(monthLabel) + "</td></tr>";
        }
...
<div class="frame-wrap">
  ...
  <style>/* fahrerauswertung-lila-schema */
    #panel-fa {{ background:#f5f3ff !important; }}
  ...
  <div id="panel-fa" style="display:none;flex:1;overflow:hidden;background:#f5f3ff;font-family:'Segoe UI',Arial,sans-serif;flex-direction:column;">
    <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;background:#ede9fe;border-bottom:1.5px solid #ddd6fe;flex-wrap:wrap;flex-shrink:0;">
      <h2 style="color:#6d28d9;font-size:16px;font-weight:900;margin:0;">&#128101; Schichten / Tachograph</h2>
      <input id="fa-search" placeholder="Fahrer suchen..." oninput="faRender(this.value);"
        style="flex:1;min-width:130px;max-width:200px;padding:5px 12px;border:2px solid #7c3aed;border-radius:5px;font-size:12px;font-family:inherit;outline:none">
      <select id="fa-year-sel" onchange="faYearChange(this.value)"
        style="padding:5px 10px;border:2px solid #7c3aed;border-radius:5px;font-size:12px;font-weight:700;color:#6d28d9;cursor:pointer;font-family:inherit;outline:none;background:#fff;">
        </select>
    ...
    <div style="display:flex;flex:1;overflow:hidden;">
      ...
      <div id="fa-detail-panel" style="flex:1;overflow-y:auto;padding:20px 24px;background:#f5f3ff;"></div>
    </div>
  </div>
  ...
  <!-- ── Spesen Panel ───────────────────────────────────── -->
  <div id="panel-spesen" style="display:none;flex:1;overflow:hidden;background:#f5f3ff;font-family:'Segoe UI',Arial,sans-serif;flex-direction:column;">
    <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;background:#ede9fe;border-bottom:1.5px solid #ddd6fe;flex-wrap:wrap;flex-shrink:0;">
      <h2 style="color:#6d28d9;font-size:16px;font-weight:900;margin:0;">&#128181; Spesen</h2>
      <input id="spesen-search" placeholder="Fahrer suchen..." oninput="spesenFilter(this.value)"
        style="flex:1;min-width:130px;max-width:220px;padding:5px 12px;border:2px solid #7c3aed;border-radius:5px;font-size:12px;font-family:inherit;outline:none">
      <select id="spesen-month-sel" onchange="spesenMonthChange(this.value)"
        style="padding:5px 10px;border:2px solid #7c3aed;border-radius:5px;font-size:12px;font-weight:700;color:#6d28d9;cursor:pointer;font-family:inherit;outline:none;background:#fff;">
      </select>
      <button onclick="spesenResetView()"
        style="padding:5px 12px;border:2px solid #7c3aed;border-radius:5px;background:#7c3aed;color:#fff;font-size:11px;font-weight:900;cursor:pointer;font-family:inherit;white-space:nowrap;box-shadow:0 1px 3px rgba(109,40,217,.25);">Reset</button>
      <div id="spesen-stats" style="font-size:11px;color:#64748b;margin-left:auto;font-weight:700;"></div>
    </div>
    <div style="display:flex;flex:1;overflow:hidden;">
      <div style="width:240px;flex-shrink:0;border-right:1.5px solid #ddd6fe;overflow-y:auto;background:#f5f3ff;">
        <div id="spesen-sidebar-list"></div>
      </div>
      <div id="spesen-detail-panel" style="flex:1;overflow-y:auto;padding:20px 24px;background:#f5f3ff;">
...
(function() {{
  ...
  function faTabBar(driverName, hasShifts, hasUebersicht) {{
    ...
    tabs.forEach(function(t) {{
      ...
      html += "<button type='button' "
            ...
            + "border-bottom:2px solid " + (active ? "#6d28d9" : "transparent") + ";"
  ...
  function _renderVacationBox(vacationRows) {{
    return _renderAbsenceBox(vacationRows, {{ title:"Urlaubstage", border:"#bae6fd", bg:"#f3e8ff", text:"#075985", badgeBg:"#f3e8ff", badgeText:"#075985" }});
  }}
  ...
  function _faRender10hRows(rows) {{
    ...
    html += "<thead><tr style='background:#fff1f2;color:#6d28d9;'>";
  ...
  window.faShow10hTours = function(driverFilter) {{
    ...
    html += "<button type='button' onclick='faExport10hPdf()' style='border:2px solid #7c3aed;background:#7c3aed;color:#fff;border-radius:5px;padding:5px 12px;font-size:12px;font-weight:950;cursor:pointer;font-family:inherit;'>PDF Tour-Häufigkeit</button>";
    ...
    html += "<button type='button' onclick='faExport10hDriverPdf()' style='border:2px solid #7c3aed;background:#7c3aed;color:#fff;border-radius:5px;padding:5px 12px;font-size:12px;font-weight:950;cursor:pointer;font-family:inherit;'>PDF Fahrer</button>";
    html += "<span style='background:#ede9fe;color:#6d28d9;border:1px solid #ddd6fe;border-radius:5px;padding:5px 12px;font-size:12px;font-weight:900;'>" + rows.length + " Treffer</span>";
  ...
  window.faBuildSidebarHighlight = function(activeName) {{
    ...
    filtered.forEach(function(d) {{
      ...
      var badgeBg = active ? "rgba(255,255,255,.18)" : "#ede9fe";
      var badgeFg = active ? "#fff" : "#6d28d9";
      ...
      html += "<div data-fa-driver='" + faEsc(d.name) + "'"
        ...
        + (vacation ? "<span style='font-size:8px;font-weight:800;padding:1px 4px;border-radius:2px;background:" + (active ? "rgba(255,255,255,.16)" : "#f3e8ff") + ";color:" + (active ? "#fff" : "#075985") + ";'>U " + vacation + "</span>" : "")
