...
st.set_page_config(page_title="NFC Generator v48", layout="wide")
_boot_log("04 Seitenkonfiguration gesetzt")

APP_CACHE_VERSION = "waschen-tanken-dashboard-2026-09-04-v48-reinigungsnachweis"
EXTRA_CACHE_VERSION = "extra-parser-2026-09-04-v48-reinigungsnachweis"
APP_DISPLAY_VERSION = "48"
...
function showArea(s) {{
  ...
  if(infosBtn) infosBtn.className = "nav-dd-btn" + ((s==="tel" || s==="bus" || s==="arzt" || s==="versp" || s==="knapp" || s==="schluessel" || s==="entgelt" || s==="schaden" || s==="maengel" || s==="lkw_uebergabe" || s==="reinigung" || s==="balzer" || s==="termine") ? " active" : "");
