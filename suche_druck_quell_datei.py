...
st.set_page_config(page_title="NFC Generator v49", layout="wide")
_boot_log("04 Seitenkonfiguration gesetzt")

APP_CACHE_VERSION = "waschen-tanken-dashboard-2026-09-04-v49-reisekosten"
EXTRA_CACHE_VERSION = "extra-parser-2026-09-04-v49-reisekosten"
APP_DISPLAY_VERSION = "49"
      ...
      <div style="background:#fff;border:1px solid #cad7e8;border-radius:12px;padding:16px 20px;box-shadow:0 2px 10px rgba(30,96,145,.08);display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap">
        <div style="display:flex;align-items:center;gap:12px;min-width:0">
          ...
          <div style="min-width:0">
            ...
            <p style="color:#64748b;font-size:12px;margin:3px 0 0 0;font-weight:500">Excel-Vorlage mit den Tabellenbl&#228;ttern &bdquo;Daten&ldquo; und &bdquo;Reisekosten&ldquo; &middot; Originaldatei ist fest in dieser HTML eingebettet</p>
          </div>
        </div>
        <div style="display:flex;gap:8px;flex-wrap:wrap">
          <button onclick="documentExcelDownload('reisekosten')" style="padding:10px 16px;background:linear-gradient(180deg,#16a34a 0%,#15803d 100%);color:#fff;border:none;border-radius:8px;font-weight:850;font-size:12px;cursor:pointer;font-family:inherit;box-shadow:0 2px 6px rgba(21,128,61,.28);display:inline-flex;align-items:center;gap:7px">&#128202; Excel herunterladen</button>
        </div>
      </div>
      <div style="background:#fff;border:1px solid #cad7e8;border-left:5px solid #16a34a;border-radius:12px;padding:22px 24px;box-shadow:0 2px 10px rgba(30,96,145,.07);color:#334155">
        <div style="display:flex;align-items:flex-start;gap:14px">
          <div style="font-size:34px;line-height:1">&#128202;</div>
          <div>
            <div style="font-size:16px;font-weight:900;color:#0f172a;margin-bottom:6px">Reisekostenabrechnung.xlsx</div>
            <div style="font-size:13px;line-height:1.55;font-weight:600;color:#64748b">Die Original-Exceldatei wird zusammen mit der <b>suche.html</b> gespeichert. Über den Button oben kann sie jederzeit wieder als echte XLSX-Datei heruntergeladen und in Excel bearbeitet werden.</div>
          </div>
        </div>
      </div>
    </div>
