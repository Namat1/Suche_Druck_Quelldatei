...
APP_CACHE_VERSION = "verstossliste-jahresfilter-2026-05-05-v11-neutral-style"
...
function spesenShowLateStarts() {
  ...
  monthKeys.forEach(function(k){
    ...
    html += "<div style='padding:10px 14px;border-bottom:1px solid #f1f5f9;background:#f8fafc;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;'>";
    ...
    if (isOpen) {
      ...
      detailList.forEach(function(v, j) {
        ...
        if (monthLabel !== currentMonth) {
          ...
          html += "<tr style='background:#f1f5f9;'><td colspan='8' style='padding:8px 12px;color:#1e3a5f;font-size:10px;font-weight:950;text-transform:uppercase;letter-spacing:.55px;border-top:1px solid #bfdbfe;border-bottom:1px solid #bfdbfe;'>" + verstossEsc(monthLabel) + "</td></tr>";
        }
...
<div class="frame-wrap">
  ...
  <div id="panel-fa" style="display:none;flex:1;overflow:hidden;background:#f8fafc;font-family:'Segoe UI',Arial,sans-serif;flex-direction:column;">
    ...
    <div style="display:flex;flex:1;overflow:hidden;">
      ...
      <div id="fa-detail-panel" style="flex:1;overflow-y:auto;padding:20px 24px;background:#f8fafc;"></div>
    </div>
  </div>
  ...
  <!-- ── Spesen Panel ───────────────────────────────────── -->
  <div id="panel-spesen" style="display:none;flex:1;overflow:hidden;background:#f8fafc;font-family:'Segoe UI',Arial,sans-serif;flex-direction:column;">
    <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;background:#f1f5f9;border-bottom:1.5px solid #cbd5e1;flex-wrap:wrap;flex-shrink:0;">
    ...
    <div style="display:flex;flex:1;overflow:hidden;">
      <div style="width:240px;flex-shrink:0;border-right:1.5px solid #cbd5e1;overflow-y:auto;background:#f8fafc;">
        <div id="spesen-sidebar-list"></div>
      </div>
      <div id="spesen-detail-panel" style="flex:1;overflow-y:auto;padding:20px 24px;background:#f8fafc;">
  ...
  <!-- ── Großkunden Panel ───────────────────────────────────────────────────── -->
  <div id="panel-gk" style="display:none;flex:1;overflow:hidden;background:#f8fafc;font-family:'Segoe UI',Arial,sans-serif;flex-direction:column;">
    <!-- Kopf / Suche -->
    <div style="flex-shrink:0;background:#f1f5f9;border-bottom:1.5px solid #cbd5e1;padding:10px 16px;box-shadow:0 1px 4px rgba(15,23,42,.06);">
      <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">
        <div style="font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.45px;color:#334155;white-space:nowrap;">Gro&#223;kunden <span id="gk-count" style="font-weight:700;color:#334155;"></span></div>
        <input id="gk-search" placeholder="Gro&#223;kunden suchen..." oninput="gkFilter(this.value)"
          style="flex:1;max-width:320px;padding:7px 11px;border:1.5px solid #cbd5e1;border-radius:6px;font-size:12px;font-family:inherit;outline:none;background:#fff;color:#334155;box-shadow:0 1px 3px rgba(15,23,42,.06);">
    ...
    <!-- Detail unten -->
    <div id="gk-detail" style="flex:1;overflow-y:auto;padding:16px 18px 28px;background:#f8fafc;">
...
function gkDistributorLinkHtml(emails, label, subject) {{
  ...
  return "<a href='" + gkAttr(gkMailto(emails, subject || label)) + "'"
       + " style='display:inline-flex;align-items:center;gap:7px;background:#cbd5e1;color:#111827;"
       + "border:1px solid #334155;border-radius:5px;padding:5px 11px;font-size:11.5px;"
...
function gkBuildTiles(activeIdx) {{
  ...
  visible.forEach(function(realIdx) {{
    ...
    var bg      = active ? "linear-gradient(180deg,#f8fafc 0%,#cbd5e1 100%)" : "#fff";
    var border  = active ? "#cbd5e1" : "#cbd5e1";
    var txtMain = active ? "#111827" : "#334155";
    var txtSub  = active ? "rgba(17,24,39,.72)" : "#334155";
    var knrBg    = active ? "rgba(17,24,39,.08)" : "#f1f5f9";
    var knrTxt   = active ? "#111827" : "#334155";
...
function gkRenderStructured(customer, detail) {{
  ...
  html += "<div style='margin-bottom:14px;display:flex;align-items:baseline;gap:14px;flex-wrap:wrap;'>"
        + "<h1 style='font-size:22px;font-weight:800;color:#334155;margin:0;letter-spacing:-.4px;line-height:1.1;'>"
  ...
  function gkKnrBadge(knr) {{
    ...
    return "<span style='display:inline-flex;align-items:baseline;gap:5px;background:#f1f5f9;"
         ...
         + "<span style='font-size:13px;font-weight:800;color:#334155;font-variant-numeric:tabular-nums;letter-spacing:.2px;line-height:1;'>"
         + gkEsc(knr) + "</span></span>";
  }}

  html += "<div style='background:#fff;border:1px solid #cbd5e1;border-radius:8px;margin-bottom:12px;overflow:hidden;'>";
  html += "<div style='padding:9px 14px;background:#f1f5f9;border-bottom:1px solid #cbd5e1;'>"
  ...
  if (anyHasAddr) {{
    ...
    standorte.forEach(function(s) {{
      html += "<div style='display:inline-flex;align-items:center;gap:9px;padding:7px 11px;background:#f1f5f9;border:1px solid #cbd5e1;border-radius:6px;'>"
  ...
  if (hasAnyContact && allContactRows.length) {{
    html += "<div style='background:#fff;border:1px solid #cbd5e1;border-radius:8px;overflow:hidden;'>";
    html += "<div style='padding:9px 14px;background:#f1f5f9;border-bottom:1px solid #cbd5e1;display:flex;align-items:center;gap:10px;flex-wrap:wrap;'>"
    ...
    allContactRows.forEach(function(cr, ri) {{
      if (cr.isLabel) {{
        ...
        html += "<div style='margin:14px 0 6px;display:flex;align-items:center;gap:10px;flex-wrap:wrap;padding-bottom:5px;border-bottom:1px solid #cbd5e1;'>"
              + "<span style='font-size:10.5px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;color:#334155;'>"
        ...
        if (hasEmail) {{
          html += cr.emails.map(function(em) {{
            ...
            return isMailAddr
              ? "<a href='mailto:" + gkEsc(em) + "' style='color:#334155;font-size:12.5px;font-weight:500;text-decoration:none;'>" + gkEsc(em) + "</a>"
        ...
        if (hasTel) {{
          html += "<span style='display:flex;align-items:center;gap:6px;flex-shrink:0;padding-left:14px;'>"
                + cr.tels.map(function(t) {{
                    ...
                    return "<a href='" + href + "' style='font-size:12.5px;font-weight:600;color:#334155;"
  ...
  if (allHints.length) {{
    html += "<div style='background:#fff;border:1px solid #cbd5e1;border-radius:8px;overflow:hidden;'>";
    html += "<div style='padding:9px 14px;background:#f1f5f9;border-bottom:1px solid #cbd5e1;display:flex;align-items:center;gap:8px;'>"
...
function gkRenderFreeform(customer, detail) {{
  ...
  html += "<div style='margin-bottom:14px;display:flex;align-items:center;gap:14px;flex-wrap:wrap;'>"
        + "<h1 style='font-size:22px;font-weight:800;color:#334155;margin:0;letter-spacing:-.4px;line-height:1.1;'>" + gkEsc(customer.name) + "</h1>"
        + gkEdekaLagerNmsLink(customer)
        + "</div>";
  ...
  (customer.lines || []).forEach(function(line) {{
    ...
    if (isSection) {{
      ...
      html += "<div style='padding:10px 14px 8px;background:#f1f5f9;border-bottom:1px solid #cbd5e1;"
      ...
      html += "<div style='padding:8px 14px;border-bottom:1px solid #f1f5f9;'>"
            + "<a href='mailto:" + gkEsc(t) + "' style='color:#334155;font-size:12.5px;font-weight:500;text-decoration:none;'>" + gkEsc(t) + "</a>"
            + "</div>";
    }} else if (hasTelNum) {{
  ...
  window.faBuildSidebarHighlight = function(activeName) {{
    ...
    filtered.forEach(function(d) {{
      ...
      html += "<div data-fa-driver='" + faEsc(d.name) + "'"
        ...
        + (vacation ? "<span style='font-size:8px;font-weight:800;padding:1px 4px;border-radius:2px;background:" + (active ? "rgba(17,24,39,.08)" : "#f1f5f9") + ";color:" + (active ? "#111827" : "#075985") + ";'>U " + vacation + "</span>" : "")
